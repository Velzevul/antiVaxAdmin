...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LoginPage = __webpack_require__(591);

	var _LoginPage2 = _interopRequireDefault(_LoginPage);

	var _FlashMessage = __webpack_require__(592);

	var _FlashMessage2 = _interopRequireDefault(_FlashMessage);

	var _QuestionsPage = __webpack_require__(593);
	...
	var App = function App(_ref) {
	  ...
	  if (user) {
	    ...
	    switch (location[0]) {
	      case 'Questions':
	        content = _react2.default.createElement(_QuestionsPage2.default, null);
	        break;
	      case 'Blog':
	        break;
	      case 'Content':
...
/***/ function(module, exports) {
	...
	// removed by extract-text-webpack-plugin
	module.exports = {"InverseButton":"Button__InverseButton___3OQXU","InverseButton_default":"Button__InverseButton_default___1jCHE","InverseButton_primary":"Button__InverseButton_primary____e3WK","Button":"Button__Button___QI7b2","Button_default":"Button__Button_default___1s2xG","Button_primary":"Button__Button_primary___351Mh","Link":"Button__Link___1qWIe"};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _locationActions = __webpack_require__(588);

	var _Layouts = __webpack_require__(489);

	var _HeaderNav = __webpack_require__(589);
	...
	var HeaderNav = function (_React$Component) {
	  ...
	  function HeaderNav(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(HeaderNav).call(this, props));
	  ...
	  _createClass(HeaderNav, [{
	    key: 'navigate',
	    value: function navigate(item, event) {
	      var dispatch = this.props.dispatch;


	      dispatch((0, _locationActions.setLocation)(0, item));
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      var navItems = ['Questions', 'Blog', 'Content', 'Users'].map(function (i) {
	        var classNames = [_HeaderNav2.default.HeaderNav__item];

	        if (location[_this2.menuLevel] === i) {
	          classNames.push(_HeaderNav2.default.HeaderNav__item_active);
	        }
	        ...
	        return _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'button',
	            { className: classNames.join(' '), onClick: function onClick(e) {
	                return _this2.navigate(i, e);
	              } },
	            i
	          )
	        );
...
/***/ function(module, exports) {
	...
	var setLocation = exports.setLocation = function setLocation(level, label) {
	  return {
	    type: SET_LOCATION,
	    level: level,
	    label: label
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Sidebar = __webpack_require__(596);

	var _Sidebar2 = _interopRequireDefault(_Sidebar);

	var _QuestionsFrequent = __webpack_require__(598);

	var _QuestionsFrequent2 = _interopRequireDefault(_QuestionsFrequent);

	var _QuestionsInbox = __webpack_require__(600);
	...
	var QuestionsPage = function (_React$Component) {
	  ...
	  _createClass(QuestionsPage, [{
	    ...
	    value: function navigate(item) {
	      ...
	      dispatch((0, _locationActions.setLocation)(1, item.id));
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      var inboxCount = _props.inboxCount;
	      var location = _props.location;
	      ...
	      if (isFetching) {
	        ...
	        var sidebarItems = [{
	          ...
	          content: _react2.default.createElement(
	            ...
	            null,
	            'Inbox',
	            _react2.default.createElement(_UI.Badge, { n: inboxCount })
	          )
	        }, {
	          id: 'frequent',
	          content: _react2.default.createElement(
	        ...
	        switch (location[1]) {
	          case 'frequent':
	            content = _react2.default.createElement(_QuestionsFrequent2.default, null);
	            break;
	          case 'inbox':
	          default:
	            content = _react2.default.createElement(_QuestionsInbox2.default, null);
	        }

	        return _react2.default.createElement(
	          _Page2.default,
	          null,
	          _react2.default.createElement(_Sidebar2.default, { items: sidebarItems,
	            active: location[1],
...
/***/ function(module, exports) {
	...
	// removed by extract-text-webpack-plugin
	module.exports = {"Page":"Page__Page___23ZJH"};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Sidebar = __webpack_require__(597);
	...
	var QuestionsSidebar = function QuestionsSidebar(_ref) {
	    ...
	    _react2.default.createElement(
	      ...
	      items.map(function (item) {
	        return _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'button',
	            { className: _Sidebar2.default.Sidebar__item + ' ' + (item.id === active ? _Sidebar2.default.Sidebar__item_active : ''),
	...
	exports.default = QuestionsSidebar;
...
/***/ function(module, exports) {
	...
	// removed by extract-text-webpack-plugin
	module.exports = {"Sidebar":"Sidebar__Sidebar___3TPTb","Sidebar__item":"Sidebar__Sidebar__item___2s-QE","Sidebar__item_active":"Sidebar__Sidebar__item_active___253wr"};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _QuestionsFrequent = __webpack_require__(599);

	var _QuestionsFrequent2 = _interopRequireDefault(_QuestionsFrequent);

	var _Body = __webpack_require__(722);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _QuestionsInbox = __webpack_require__(601);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reduxLogger = __webpack_require__(604);
	...
	var _rootReducer = __webpack_require__(606);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _authReducer = __webpack_require__(607);

	var _authReducer2 = _interopRequireDefault(_authReducer);

	var _flashReducer = __webpack_require__(609);

	var _flashReducer2 = _interopRequireDefault(_flashReducer);

	var _locationReducer = __webpack_require__(610);

	var _locationReducer2 = _interopRequireDefault(_locationReducer);

	var _questionsReducer = __webpack_require__(724);
...
/***/ function(module, exports) {
	...
	exports.default = {
	  ...
	  auth: {
	    ...
	    //   ]
	    // },
	    // token: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..258OMn9QxSkkQPo2HxgsB5VNSKtErz0kggYnyT0RKTQ'
	    user: null,
	    token: null
	  },
	  flash: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var location = function location() {
	  var state = arguments.length <= 0 || arguments[0] === undefined ? _initialState2.default.location : arguments[0];
	  var action = arguments[1];
	  ...
	  switch (type) {
	    case _locationActions.SET_LOCATION:
	      var newLocation = state.slice(0, level);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Body = __webpack_require__(723);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var questions = function questions() {
	  ...
	  switch (action.type) {
	    case _locationActions.REQUEST_QUESTIONS:
	      return _extends({}, _initialState2.default.questions, {
	        isFetching: true
	      });
	    case _locationActions.RECEIVE_QUESTIONS:
	      return {
	        isFetching: false,
	        items: action.items
	      };
